...
public class ClientLogin_View extends JFrame {
    ...
    public ClientLogin_View() {
        ...
        // --- Testo "Utilizza il tuo account postgreSQL" ---
        ...
        passwordLabel.setFont(new Font("Segoe UI", Font.BOLD, 16)); // Font a tua scelta
        ...
        gbc.gridy = 2; // Riga 2 (sotto il campo password che è in riga 1)
        ...
        // --- JLabel "Crea un account" ---
        goToRegisterLabel = new JLabel("<html><u>Crea un account</u></html>"); // Ho corretto il testo della label, prima era solo "a"
        goToRegisterLabel.setForeground(Color.WHITE); // Colore del testo bianco
        goToRegisterLabel.setFont(new Font("Segoe UI",Font.PLAIN, 16)); // Font a scelta
        gbc.gridx = 0; // Colonna 0 (sotto la label "Errore login")
        gbc.gridy = 3; // Riga 3 (sotto il campo password che è in riga 1)
        gbc.gridwidth = 2; //  Questo fa in modo che la label occupi 2 colonne 
        gbc.anchor = GridBagConstraints.WEST; // Allinea a sinistra
        gbc.fill = GridBagConstraints.NONE; // Non far espandere la label
        gbc.weightx = 0.0; // Non dare peso orizzontale
        gbc.insets = new Insets(30, 0, 12, 0); // Spazio interno: top, left, bottom, right.
        ...
        gbc.gridx = 0;
        gbc.gridy = 4;
        gbc.gridwidth = 2; // Mantienilo, o prova 3 se hai più colonne o se c'è una colonna invisibile.
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.NONE; // Mantieni NONE, poiché non vogliamo che si estenda
        gbc.weightx = 0.0;
